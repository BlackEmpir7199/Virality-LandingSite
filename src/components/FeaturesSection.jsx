...
const FeaturesSection = () => {
  return (
    <div className="relative mt-20 border-b-0 border-neutral-800 min-h-[800px]">
        ...
        <div className="flex flex-wrap mt-10 lg:mt-20 mx-2">
            {
                features.map((feature, index)=>(
                    <div key={index} className='w-full lg:w-1/3 sm:w-1/2'>
                        <div className='flex mt-12 p-2 space-x-0 border mx-1 pt-10 pb-0 rounded-md hover:shadow-orange-900 hover:shadow-lg border-neutral-700 border-[2px] transition-colors-1s  hover:scale-[1.1] hover:bg-neutral-900 hover:border-orange-500 '>
